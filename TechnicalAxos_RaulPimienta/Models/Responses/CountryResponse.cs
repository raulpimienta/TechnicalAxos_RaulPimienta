...
using static TechnicalAxos_RaulPimienta.Models.Responses.CountryResponse;

namespace TechnicalAxos_RaulPimienta.Models.Responses
{
    public class CountryResponse
    {
        ...
        public string CapitalDisplay { get { return capital?.Count > 0 ? string.Join(", ", capital.Select(c => c)) : "No capital"; } }
    }
